    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0a1628] px-6 py-10">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="my-6 flex items-center gap-3">
          ...
          <span className="text-xs text-white/40">nebo</span>
          <div className="h-px flex-1 bg-white/10" />
        </div>
        ...
        <div className="space-y-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-white/15 bg-white/5 py-3.5 text-sm font-medium text-white transition hover:bg-white/10"
          >
