...
export function IconBat({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      {/* Pálka */}
      <path d="M6.5 20.5 18 4" />
      <path d="M16.5 5.5c1.5-1.5 3.5-1.2 4.5 0s1.5 3 0 4.5" />
...
export function IconRunner({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      ...
      <path d="M11 21l1.5-5.5 2 2 3.5-3" />
      <path d="M6.5 12.5 11 14l1.5-3.5 3.5.5" />
      <path d="M9 21l1-3" />
    </svg>
  );
}
...
export function IconHomeRun({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      ...
      <path d="M12 3c2.2 3 2.2 6 0 9s-2.2 6 0 9" />
      <path d="M3 12h18" />
    </svg>
  );
}
...
/** Klasické ozubené kolo (settings) */
